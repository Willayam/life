...
## Result
Income that covers life without trading hours for money. 10-15M SEK saved for apartment. Debt eliminated. Parental leave maximized.

## Purpose
Financial freedom = time freedom. I never want to take a project because I *have* to. I want to build from desire, not desperation. My family deserves security.
...
| Item | Amount |
|------|--------|
| Monthly income (Inkarnate) | 90,000 SEK |
...
### Income Sources
- **Inkarnate consulting:** 90,000 SEK/month (active - requires ongoing work)
- **Expa:** Winding down. Potential small income from ads/AI automation for dad.
- **Clarity.video:** Proposal sent, awaiting reply. Potential new engagement.
- **Maxa:** Pre-revenue. Target launch ASAP.
...
- [ ] Debt fully cleared, savings rebuilding
- [ ] Salary history established for maximum parental leave payout
- [ ] Clarity engagement active (if closed)
- [ ] Start content creation (builds toward product distribution)

### Phase 3: Parental Leave & Scale (Aug-Dec 2026)
- [ ] Parental leave with maximized SGI payout
- [ ] Maxa running and growing (systems in place)
- [ ] Content building audience
- [ ] Evaluate: Can I reduce/drop consulting when leave ends?

---

## Parental Leave Optimization (CRITICAL - TIME SENSITIVE)

**Baby due: End of July 2026**
**Months remaining to optimize: ~5 months (Feb-Jun)**

### How SGI (Sjukpenninggrundande inkomst) Works
- Försäkringskassan bases parental leave pay on your established income level
- For business owners: they look at your salary payment pattern
- **Inconsistent salary = lower SGI = less parental leave money**
...
## Path to 10-15M SEK (3-Year Horizon)

This won't come from consulting. It comes from:

1. **Product revenue (Maxa + future apps)** - Recurring subscriptions at scale
2. **Content/brand monetization** - Once audience is built
3. **Equity/ownership in things** - Products you own, not hours you sell
4. **Compound savings** - Once income exceeds needs by a wide margin

### Back-of-Napkin Math
- Maxa at 10,000 subscribers x 100 SEK/month = 1M SEK/month
- Even at 1,000 subscribers x 100 SEK/month = 100K SEK/month (replaces consulting)
- Multiple products multiply this

**The leverage play:** Each product you build has near-zero marginal cost per user. This is why consulting can never get you to 10-15M - but products can.
...
- [ ] What is remaining debt?
- [ ] What is savings balance?
- [ ] Is Maxa generating revenue? How much?
- [ ] Am I on track for parental leave SGI target?
